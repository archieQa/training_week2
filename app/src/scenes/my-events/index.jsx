    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button onClick={() => setFilter("published")} className={`px-3 py-1 rounded ${filter === "published" ? "bg-indigo-600 text-white" : "bg-gray-200"}`}>
            Published
          </button>
        </div>
      </div>
      ...
      {memoizedEvents.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <button onClick={() => dispatch({ type: "OPEN" })} className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
            <AiOutlinePlus className="w-5 h-5" />
